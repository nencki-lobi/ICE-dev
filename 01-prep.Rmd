...
```{r, include=FALSE}
nexcluded_variance = nrow(dataset) - length(allgood)
```
...
The total number of participants excluded based on variance of responses is:  **`r nexcluded_variance` participants**.
