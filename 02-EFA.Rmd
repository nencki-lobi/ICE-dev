...
PA = PA_FA(cor_matrix, Nfactors=params$factors, iterpaf=250, rotate="none", verbose=T, Ncases=nrow(dataset))
```
...
``` {r}
fname = paste("./02/output/items-per-factor-", as.character(params$factors),".tsv", sep="")
