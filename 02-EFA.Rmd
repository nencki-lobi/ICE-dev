...
colnames(phi) = c("Factor 1", "Factor 2", "Factor 3", "Factor 4", "Factor 5", "Factor 6", "Factor 7")
rownames(phi) = c("**Factor 1**", "**Factor 2**", "**Factor 3**", "**Factor 4**", "**Factor 5**", "**Factor 6**", "**Factor 7**")
```
